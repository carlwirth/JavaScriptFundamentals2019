//   why...
// The longer I sit in this classroom, the more stupid I feel.

const showCommentsButton = documents.querySelector("#showComments");
showCommentsButton.addEventsListener("click", () => {
    const comments = documents.querySelector("#comments");
...
// const button2 = document.querySelector(".btn.btn-secondary2");
// const handleClick = () => {

//     const hiddenElement = document.querySelector('.block');
